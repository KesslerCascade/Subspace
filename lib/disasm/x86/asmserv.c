...
const t_cmddata cmddata[] = {
    ...
    // SSE instructions
    { 0xFFFFFF, 0x100FF3, 2,00,  RXM,MX4,NNN, C_SSE + 4,          I_MOVSS },
    { 0xFFFFFF, 0x110FF3, 2,00,  MX4,RXM,NNN, C_SSE + 4,          I_MOVSS },
    { 0xFFFFFF, 0x100FF2, 2,00,  RXM,MX8,NNN, C_SSE + 8,          I_MOVSD },
    { 0xFFFFFF, 0x110FF2, 2,00,  MX8,RXM,NNN, C_SSE + 8,          I_MOVSD },
    { 0xFFFFFF, 0x2A0FF3, 2,00,  RXM,MR4,NNN, C_SSE + 4,          I_CVTSI2SS },
    ...
    { 0xFFFFFF, 0x5C0FF2, 2,00,  RXM,MX8,NNN, C_SSE + 8,          I_SUBSD },
    { 0xFFFFFF, 0x590FF3, 2,00,  RXM,MX4,NNN, C_SSE + 4,          I_MULSS },
    { 0xFFFFFF, 0x590FF2, 2,00,  RXM,MX8,NNN, C_SSE + 8,          I_MULSD },
    { 0xFFFFFF, 0x5E0FF3, 2,00,  RXM,MX4,NNN, C_SSE + 4,          I_DIVSS },
